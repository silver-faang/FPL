class Calendar {
    constructor(elementId,day,month,year) {
        ...
        this.notesCell = document.getElementById('myTable');
    ...
    addInputField(date,month,year) {
        ...
        saveButton.addEventListener('click', () => {
            ...
            // note{ title: description: completed: date: priority }
            this.saveNote(date+" "+this.monthName(month)+" "+year, input.value);
    ...
    displayNote(date, note) {
        const noteData = document.createElement('tr');
        noteData.className = 'note';
        ...
        this.notesCell.appendChild(noteData);
    }
